module.exports = async (bot,message,args,argsF) => {
    ...
    userObjectGroup.status = 'union'
    objectGroup.invate = null
    objectGroup.status = 'union'
    Memory.save()
    return message.reply({
        content: `Группировка <@&${args.accepter}> принимает союз группировки <@&${args.invater}>`
    })
    
};

module.exports.names = ["acceptunion"]; //У неё есть название
module.exports.interaction = { //И слэш команда
    name: 'acceptunion', //И название должно быть такое, как у команды
